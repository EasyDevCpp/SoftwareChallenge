        ...
        if(step == 0) { //to first salad
            ...
            if(super.getPlayer().getFieldIndex() > super.getEnemy().getFieldIndex()){
                ...
                if(isMovePlayable(1, FieldType.SALAD)){
                    ...
                    setNewTask(1);
                    step = 2;
                } else if(!enemyOnNextFieldType(FieldType.CARROT) && super.getKarrotCosts()[b.getNextFieldByType(FieldType.CARROT, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()] <= super.getPlayer().getCarrots() && b.getNextFieldByType(FieldType.CARROT, super.getPlayer().getFieldIndex()) < b.getNextFieldByType(FieldType.SALAD, super.getPlayer().getFieldIndex())){
                    super.getActions().add(new Advance(b.getNextFieldByType(FieldType.CARROT, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()));
                    setNewTask(2);
                } else if(super.getKarrotCosts()[b.getNextFieldByType(FieldType.POSITION_2, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()] <= super.getPlayer().getCarrots() && b.getNextFieldByType(FieldType.POSITION_2, super.getPlayer().getFieldIndex()) < b.getNextFieldByType(FieldType.SALAD, super.getPlayer().getFieldIndex())){
                    super.getActions().add(new Advance(b.getNextFieldByType(FieldType.POSITION_2, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()));
                } else if(!enemyOnNextFieldType(FieldType.HARE) && super.getPlayer().getCards().contains(CardType.EAT_SALAD) && super.getKarrotCosts()[b.getNextFieldByType(FieldType.HARE, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()] <= super.getPlayer().getCarrots() && b.getNextFieldByType(FieldType.HARE, super.getPlayer().getFieldIndex()) < b.getNextFieldByType(FieldType.SALAD, super.getPlayer().getFieldIndex())){
                    super.getActions().add(new Advance(b.getNextFieldByType(FieldType.HARE, super.getPlayer().getFieldIndex()) - super.getPlayer().getFieldIndex()));
                    super.getActions().add(new Card(CardType.EAT_SALAD, 1));
