...
public class Starter extends AbstractClient {
    ...
    public Starter(String host, int port, String reservation, String strategy)
        ...
        try {
            //logic = LogicFactory.valueOf(strategy.toUpperCase()).getInstance(this);                               //Standart auswahl, so kann über Kommandozeile Strategfie geändert werden, andernfalls nicht mehr
            logic = LogicFactory.LOGIC.getInstance(this);
